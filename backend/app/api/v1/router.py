...
# Mismo prefijo, puerta distinta: el contenido Rx exige medico validado; la acreditacion propia no.
api_router.include_router(acreditacion.router, prefix="/medicos", tags=["medicos"])
